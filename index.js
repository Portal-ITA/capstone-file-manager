...
module.exports = class {
   ...
   * @param {object} list - capstone list
   */
  constructor(list) {
    this.list = list;
  ...
  /**
   * Wrap original capstone.List.prototype.add method related to current list.
  ...
  /**
   * On 'post save' hook copy uploaded image to /dist/images folder. It is necessary, because Capstone serve files from dist folder, and we store files in public folder. Dist folder is generated
